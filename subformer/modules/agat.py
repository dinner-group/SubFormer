## https://github.com/pyg-team/pytorch_geometric/blob/ba54c72512859bdd4996f5e64ea5566d5d74db0a/torch_geometric/nn/conv/antisymmetric_conv.py#L14
import math
...
from torch_geometric.nn.conv import GCNConv, MessagePassing, GINEConv, GATv2Conv
from torch_geometric.nn.inits import zeros
from torch_geometric.nn.resolver import activation_resolver
from torch_geometric.typing import Adj
from torch.nn import init, Sequential, Linear, Dropout, ReLU

class AGATConv(torch.nn.Module):
    ...
    def __init__(
        ...
        if phi is None:
            phi = GATv2Conv( train_eps=True,edge_dim=in_channels,out_channels=in_channels,in_channels=in_channels,heads=1)
    ...
    def forward(self, x: Tensor, edge_index: Adj, edge_attr:Tensor, *args, **kwargs) -> Tensor:
        r"""Runs the forward pass of the module."""
        antisymmetric_W = self.W - self.W.t() - self.gamma * self.eye

        for i in range(self.num_iters):
            h = self.phi(x, edge_index, edge_attr, *args, **kwargs)
